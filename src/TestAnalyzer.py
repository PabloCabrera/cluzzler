...
class TestAnalyzer (CellAnalyzer):
	def __init__ (analyzer):
		...
		analyzer.setMetric ("ascending_left", ascending_left)
		analyzer.setMetric ("ascending_right", ascending_right)
		analyzer.setMetric ("ascending_up", ascending_up)
		analyzer.setMetric ("ascending_down", ascending_down)
